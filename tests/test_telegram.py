...
from tg_drop_bot.services.telegram import chat_member_status_value, is_channel_member
...
async def test_is_channel_member_handles_string_status() -> None:
    class BotStub:
    ...
    is_member, status = await is_channel_member(cast(Bot, BotStub()), -100123, 42)
